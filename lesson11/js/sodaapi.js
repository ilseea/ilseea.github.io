const weatherURL = 'https://api.openweathermap.org/data/2.5/weather?id=5607916&APPID=1d982ee27d3310460b15a19c65fa132b&units=imperial';
...
const forecastURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5607916&APPID=1d982ee27d3310460b15a19c65fa132b&units=imperial';
fetch(forecastURL)
    .then((response) => response.json())
    .then((jsObject) => {
